...
export const DAILY_COMPANION_RANKS: number[] = [
  ...
  1, 2, 4, 5, 7, 8, 10, 12, 13, 15, 19, 22, 29, 30, 2, 4, 5, 7, 10, 13, 1, 3, 4, 5, 8, 9, 12, 19,
  22, 25, 29, 30, 2, 7, 10, 1, 4, 5, 2, 8, 7, 12, 13, 4, 19, 5, 10, 2, 1, 29, 30, 22, 8, 15, 25, 4,
  5, 7, 10, 2, 1, 12, 13, 4, 5, 9, 8, 19, 22, 7, 10, 2, 30, 29, 4, 1, 5, 2, 13, 10, 7, 8, 12, 4, 19,
  5, 1, 2, 22, 29, 30, 10, 13, 15, 25, 7, 4, 5, 2, 1, 8, 10, 12, 13, 4, 5, 9, 2, 7, 19, 22, 1, 29,
  30, 4, 5, 10, 2, 13, 8, 7, 4, 12, 1, 19, 5, 22, 29, 30, 10, 2, 13, 8, 15, 25, 4, 5, 7, 10, 2, 1,
  12, 13, 4, 5, 9, 8, 19, 2, 7, 22, 10, 29, 30, 1, 4, 5, 2, 13, 10, 7, 8, 12, 4, 19, 5, 1, 2, 22,
  29, 10, 13, 15, 25, 7, 4, 5, 2, 1, 8,
  // fill remaining to reach 354
  1, 2, 4, 5, 7, 8, 10, 12, 4, 5, 7, 10, 1, 2, 4, 5, 7, 8, 10, 12, 4, 5, 7, 10, 1, 2, 4, 5, 7, 8,
  10, 12, 4, 5, 7, 10, 1, 2, 4, 5, 7, 8, 10, 12, 4, 5, 7, 10, 1, 2, 4, 5, 7, 8, 10, 12, 4, 5,
];
...
export const STREAK_MILESTONES: StreakMilestone[] = [
  ...
  },
  {
    days: 7,
    companionRank: 29,
    companionName: 'Salman al-Farisi',
    color: '#509070',
    badge: '🗺',
    title: 'The Seeker',
  ...
  },
  {
    ...
    title: 'The Student',
    quote:
      '"I served the Messenger of Allah ﷺ for ten years and he never once said \'uff\' to me."',
  ...
  },
  {
    ...
    color: '#b8860b',
    badge: '🏅',
    title: 'Al-Siddiq — The Unwavering',
    quote:
    ...
    unlocks:
      "100 days: Full site unlocked + Abu Bakr's complete legacy archive + all premium features",
  },
];
